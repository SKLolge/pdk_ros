...
class RadarStatus final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 u_ethernet_vlan() const;
  void set_u_ethernet_vlan(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_u_ethernet_vlan() const;
  void _internal_set_u_ethernet_vlan(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 u_ethernet_vlan_;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RadarStatus::_internal_u_ethernet_vlan() const {
  return u_ethernet_vlan_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RadarStatus::u_ethernet_vlan() const {
  // @@protoc_insertion_point(field_get:pb.PDK.RadarStatus.u_Ethernet_VLAN)
  return _internal_u_ethernet_vlan();
}
inline void RadarStatus::_internal_set_u_ethernet_vlan(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
  u_ethernet_vlan_ = value;
}
inline void RadarStatus::set_u_ethernet_vlan(::PROTOBUF_NAMESPACE_ID::uint32 value) {
