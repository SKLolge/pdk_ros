...
namespace pb {
namespace PDK {
constexpr SensorMsgHeader::SensorMsgHeader(
...
struct SensorMsgHeaderDefaultTypeInternal {
  constexpr SensorMsgHeaderDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SensorMsgHeaderDefaultTypeInternal _SensorMsgHeader_default_instance_;
}  // namespace PDK
}  // namespace pb
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_pdk_5fSensorMsgHeader_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_pdk_5fSensorMsgHeader_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_pdk_5fSensorMsgHeader_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_pdk_5fSensorMsgHeader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::pb::PDK::_SensorMsgHeader_default_instance_),
};
...
const char descriptor_table_protodef_pdk_5fSensorMsgHeader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "TE_INVALID\020\002\"S\n\nSensorType\022\014\n\010ARS430EO\020\000"
  "\022\014\n\010ARS430DI\020\001\022\014\n\010SRR520CO\020\003\022\016\n\nARS540DE"
  "MO\020\004\022\013\n\007UNKNOWN\020c"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_pdk_5fSensorMsgHeader_2eproto_deps[1] = {
  &::descriptor_table_pdk_5fMsgHeader_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_pdk_5fSensorMsgHeader_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_pdk_5fSensorMsgHeader_2eproto = {
  false, false, 457, descriptor_table_protodef_pdk_5fSensorMsgHeader_2eproto, "pdk_SensorMsgHeader.proto", 
  ...
  file_level_metadata_pdk_5fSensorMsgHeader_2eproto, file_level_enum_descriptors_pdk_5fSensorMsgHeader_2eproto, file_level_service_descriptors_pdk_5fSensorMsgHeader_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_pdk_5fSensorMsgHeader_2eproto_getter() {
  return &descriptor_table_pdk_5fSensorMsgHeader_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_pdk_5fSensorMsgHeader_2eproto(&descriptor_table_pdk_5fSensorMsgHeader_2eproto);
namespace pb {
namespace PDK {
...
void SensorMsgHeader::ArenaDtor(void* object) {
  SensorMsgHeader* _this = reinterpret_cast< SensorMsgHeader* >(object);
  (void)_this;
}
void SensorMsgHeader::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* SensorMsgHeader::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
...
::PROTOBUF_NAMESPACE_ID::uint8* SensorMsgHeader::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        1, _Internal::t_commonheader(this), target, stream);
  }

  // optional uint32 u_SensorId = 2;
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(2, this->_internal_u_sensorid(), target);
  }
    ...
    if (cached_has_bits & 0x00000002u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32Size(
          this->_internal_u_sensorid());
    }

    // optional .pb.PDK.SensorMsgHeader.SignalStatus e_SignalStatus = 3 [default = EM_SIGSTATE_INVALID];
    if (cached_has_bits & 0x00000004u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->_internal_e_signalstatus());
    }

    // optional .pb.PDK.SensorMsgHeader.SensorType e_SensorType = 4 [default = UNKNOWN];
    if (cached_has_bits & 0x00000008u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->_internal_e_sensortype());
    }
...
template<> PROTOBUF_NOINLINE ::pb::PDK::SensorMsgHeader* Arena::CreateMaybeMessage< ::pb::PDK::SensorMsgHeader >(Arena* arena) {
