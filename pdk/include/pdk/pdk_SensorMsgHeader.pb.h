...
class SensorMsgHeader final :
 ...
 public:
  ...
  explicit constexpr SensorMsgHeader(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline SensorMsgHeader* New() const final {
    return new SensorMsgHeader();
  }

  SensorMsgHeader* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT ::pb::PDK::MsgHeader* release_t_commonheader();
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 u_sensorid() const;
  void set_u_sensorid(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_u_sensorid() const;
  void _internal_set_u_sensorid(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 u_sensorid_;
  int e_signalstatus_;
  int e_sensortype_;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 SensorMsgHeader::_internal_u_sensorid() const {
  return u_sensorid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 SensorMsgHeader::u_sensorid() const {
  // @@protoc_insertion_point(field_get:pb.PDK.SensorMsgHeader.u_SensorId)
  return _internal_u_sensorid();
}
inline void SensorMsgHeader::_internal_set_u_sensorid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
  u_sensorid_ = value;
}
inline void SensorMsgHeader::set_u_sensorid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
